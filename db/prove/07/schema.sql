...
CREATE TABLE service_vehicle (
   ...
   -- constraints
   CONSTRAINT vin_length CHECK (CHAR_LENGTH(vin) = 17)
);
...
VALUES
   ...
   ('tjensen', 'Tyler', 'Jensen', 'technician'),
   ('bjensen', 'Brett', 'Jensen', 'technician');
...
VALUES
   ('94719285662134563', 'silver', 'Ford', 'Focus', 2010, (SELECT customer_email FROM service_customer WHERE (name_first='Zach' AND name_second='Delano'))),
